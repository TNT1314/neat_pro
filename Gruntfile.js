...
//            },
        ...
        less:{
            production:{
                ...
                files: {
                    ...
                    "project_build/css/neat.css": "project_src/less/neat.less"
                }
            } 
        },
        ...
        //     options: {
        //         csslintrc: 'project_frofile/.csslintrc'
        //     },
        //     strict: {
        //         options: {
        //             import: 2
        //         },
        //         src: ["<%=pkg.outpath%>/css/*.css"]
        //     }
        // },
    ...
    //注册默认插件执行
    grunt.registerTask('default', ['uglify', 'less', 'clean', 'copy',  'jshint',  'watch']);
};